    ...
    <div className="flex flex-col h-full">
      <div className="flex-none p-6 border-b border-border">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-display font-bold text-text-primary">Jump Search</h1>
            <p className="text-text-secondary mt-2">Checking fewer elements than linear search by jumping ahead by fixed blocks in a sorted array.</p>
          </div>
      ...
      <div className="flex-1 p-6 flex flex-col gap-6 overflow-hidden">
        ...
        <div className="flex-none space-y-4">
          <div className="bg-bg-card border border-border rounded-lg p-4 flex items-center justify-between">
            ...
            {currentStepData?.auxiliaryState?.stateInfo && (
